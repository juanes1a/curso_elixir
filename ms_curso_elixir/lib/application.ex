defmodule MsCursoElixir.Application do
  alias MsCursoElixir.Infrastructure.EntryPoint.ApiRest
  alias MsCursoElixir.Config.{AppConfig, ConfigHolder}
  alias MsCursoElixir.Utils.CertificatesAdmin
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: MsCursoElixir.Supervisor]
